...
type Cheer = { id: string; message?: string | null; sender: { id: string; email: string } };
  ...
  return (
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full flex justify-center items-center z-50">
      <div className="bg-white dark:bg-gray-800 p-5 rounded-lg shadow-xl w-full max-w-md">
        <h3 className="text-lg font-bold mb-4 text-gray-900 dark:text-white">Cheers for {habitName}</h3>
        {isLoading ? <p className="text-gray-700 dark:text-gray-300">Loading cheers...</p> : (
        ...
        <div className="mt-4">
          ...
          <div className="flex justify-end gap-2">
            <Button
              ...
              className={disableSendCheer ? "opacity-50 cursor-not-allowed" : ""}
